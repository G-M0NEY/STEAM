...
import yellow from './media/yellowHeart.png'
import red from './media/redHeart.png'
import purple from './media/purpleHeart.png'
import green from './media/greenHeart.png'
import orange from './media/orangeHeart.png'
...
=======
>>>>>>> 8ce694780414f689c84c794e6637bed0cee0b8c2
          ...
          const createBoard = () => {
            setCurrentColorArrangement(
              [...Array(width * width)].map(
                (_) => candyColors[Math.floor(Math.random() * candyColors.length)]
              )
            );
          };
